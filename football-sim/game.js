...
function save(){localStorage.setItem("gcs_v071",JSON.stringify(state));}
function load(){let s=localStorage.getItem("gcs_v071");if(s){state=JSON.parse(s);return true;}return false;}
